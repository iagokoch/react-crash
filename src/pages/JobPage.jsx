          ...
          <div className="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
            <main>
              ...
              <div className="bg-black p-6 rounded-lg shadow-md mt-6">
                ...
                <p className=" text-white mb-4">{job.salary} / Year</p>
              </div>
            </main>
            ...
            <aside>
              <div className="bg-black p-6 rounded-lg shadow-md">
                ...
                <h2 className=" text-white text-2xl">{job.company.name}</h2>

                <p className=" text-white my-2">{job.company.description}</p>

                <hr className="my-4" />

                <h3 className=" text-white text-xl">Contact Email:</h3>

                <p className="my-2 bg-red-100 p-2 font-bold rounded-xl">
                  {job.company.contactEmail}
                </p>

                <h3 className=" text-white text-xl">Contact Phone:</h3>
